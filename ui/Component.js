...
class Component extends DOMElement.Delegator {
  ...
  */
  ...
  insertAt(pos, childEl) {
    ...
    let child = new RenderingEngine()._renderChild(this, childEl)
...
extend(Component.prototype, EventEmitter.prototype)
...
class TextNodeComponent extends Component {
  ...
  setTextContent(text) {
    ...
    if (this.el.textContent !== text) {
      let newEl = this.el.createTextNode(text)
